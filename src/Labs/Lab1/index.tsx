  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe Tomato Egg Soup:
        <ol id="wd-your-favorite-recipe">
          <li>Prepare 2 fresh tomatos, 2 eggs</li>
          <li>Add 1/3 water in a pot, heat to boiling point</li>
          <li>Add in the peeled tomatos, stir for a minute</li>
          <li>Add 2 spoons of sugar and salt</li>
          <li>Break and stir egg in a separate bowl</li>
          <li>Pour from the pot into the bowl, stir for half a minute</li>
          <li>Serve and enjoy!</li>
        </ol>
...
_Starship-gap2.jpg"
      ...
      <a
        id="wd-github"
        href="https://github.com/Jerrytian993/kanbas-react-web-app"
      >
        click here
      </a>
